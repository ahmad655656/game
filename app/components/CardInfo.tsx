...
const CardInfo = ({description, title, image, textBtn, btnClasses} : {description: string, title: string, image: string, textBtn?: string, btnClasses?: string}) => {
  return (
      <MotionItem initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0, transition: {duration: 1} }} className="absolute flex flex-col gap-2 items-start top-5 left-5 lg:left-20 lg:top-20 max-w-md">
