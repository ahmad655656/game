  ...
  return (
    ...
    <form className="mt-6">
        ...
        <div className="mt-4">
            ...
            <input type="password" placeholder="Password" className="block border-b-white/70 border-b-[1px] w-full px-4 py-2 mt-2 text-white bg-transparent rounded-sm focus:outline-none" />
        </div>
    ...
    <p className="mt-8 text-xs font-light text-center text-white/70"> Don't have an account? <a href="/signup" className="font-medium text-rose-500 dark:text-gray-200 hover:underline">Create One</a></p>
</div>
      </MaxWidthWrapper>
    </MotionItem>
  );
